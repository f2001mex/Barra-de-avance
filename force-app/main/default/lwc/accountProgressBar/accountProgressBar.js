...
const FIELDS = ['Account.Avance_FAC__c'];

export default class AccountProgressBar extends LightningElement {
    @api recordId;
    ...
    get percent() {
        const rawValue = getFieldValue(this.record.data, FIELDS[0]);
